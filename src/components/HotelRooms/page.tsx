            ...
            >
                ...
                <div className="relative z-10 max-w-7xl mx-auto px-5 sm:px-8 lg:px-12 py-24 lg:py-36">
                    ...
                    <div className="text-center mb-14 lg:mb-20">
                        ...
                        <p
                            className={`text-white/50 font-light max-w-lg mx-auto leading-relaxed text-[13px] sm:text-sm ${inView ? "hr-fadeUp" : "opacity-0"}`}
                            ...
                            <div className="space-y-3">
                                {benefits.map((b, i) => (
                                    ...
                                    >
                                        ...
                                        {/* Text */}
                                        <p className="text-white/65 text-[12.5px] sm:text-sm font-light leading-relaxed pt-0.5">
